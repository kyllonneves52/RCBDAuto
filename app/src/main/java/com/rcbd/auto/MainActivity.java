...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviar.setOnClickListener(v -> {
            ...
            QueueManager.adicionar(this, pacote, tel);
            int total = QueueManager.quantidade(this);
            fila.setText("Pedidos: " + total);
            log.setText("Pedido criado:\n" + pacote + " MB\nNúmero: " + tel);
            Toast.makeText(this, "Pedido colocado na fila", Toast.LENGTH_LONG).show();
        ...
        diagnostico.setOnClickListener(v -> {
            ...
            Toast.makeText(this, "Teste RCBDAuto", Toast.LENGTH_SHORT).show();
        });
